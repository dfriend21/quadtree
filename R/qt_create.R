...
#' @param range_limit numeric; if the cell values within a quadrant have a range larger than this value, the quadrant is split. See 'Details' for more
#' @param adj_type character; either \code{'expand'} or \code{'resample'}. See 'Details' for more.
#' @param resample_n_side integer; if \code{adj_type} is \code{'expand'}, this number is used to determine the dimensions to resample the raster to
#' @details 
