...
# `quadtree`: An R-package for raster-like quadtrees

This package provides functionality for working with raster-like
quadtrees (also called “region quadtrees”), which allow for
...
I’d recommend beginning with “Quadtree Creation” - this covers the
